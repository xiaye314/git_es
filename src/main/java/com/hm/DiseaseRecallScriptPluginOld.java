...
public class DiseaseRecallScriptPluginOld extends Plugin implements ScriptPlugin {
    ...
    public static class MyNativeScript extends AbstractSearchScript {
        ...
        public Object run() {
            ...
            List<Long> userNoneSymptomList = (List<Long>) params.get("userNoneSymptom");
            if (userNoneSymptomList == null) userNoneSymptomList = new ArrayList();
            Set<Long> userNoneSymptomSet = new HashSet();
            for (Long userNoneSymptomId : userNoneSymptomList) {
                userNoneSymptomSet.add(Long.valueOf(userNoneSymptomId));
            }
            List<String> symptomList = (List<String>) source().get("symptomList");
            ...
            List<String> userSymptomList = (List<String>) params.get("userSymptom");
            ...
            List<String> symptomGroupList = (List<String>) params.get("symptomGroup");
            ...
            if (gender != null && age != null) {
                ...
                List<String> distGroupList = (List<String>) source().get("distGroup");
                ...
                List<String> distGroupByGenderSeasonList = (List<String>) source().get("distGroupByGenderSeason");
                ...
                String ageGroup = calcAgeGroup(age);
                List<String> distGroupByAgeGroupSeasonList = (List<String>) source().get("distGroupByAgeGroupSeason");
                ...
                List<String> distGroupBySeasonList = (List<String>) source().get("distGroupBySeason");
            ...
            Integer isCritical = (Integer) source().get("isCritical");
            ...
            boolean debug = false;
            Object debugObj = params.get("debug");
            if (debugObj != null) debug = (boolean) debugObj;
            if (debug) {
                // 打印分数
                return debugResult;
